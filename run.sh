...
if [ "$1" = "import" ]; then
    ...
    # Import shapefiles
    /home/renderer/src/openstreetmap-carto/scripts/get-external-data.py --c /home/renderer/src/openstreetmap-carto/external-data.yml -d gis -U renderer -w renderer -p 5432 -H localhost -D /home/renderer/src/openstreetmap-carto/data
